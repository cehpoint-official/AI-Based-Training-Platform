            ...
            <div className='dark:bg-black flex-1'>
                {!quizCompleted ? (
                    ...
                    <div className='flex-1 flex flex-col items-center justify-center py-8'>
                        ...
                        <p className='text-center font-normal text-black py-4 dark:text-white'><strong>{userName}</strong> on completion of course <strong>{courseTitle}</strong>. <br /> Download your certificate</p>
