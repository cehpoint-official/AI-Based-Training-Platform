                            ...
                            {showApiKeyForm && (
                                <form onSubmit={handleSubmitApiKey}>
                                    ...
                                    <p className="text-center text-sm text-gray-500 dark:text-gray-400 mb-5">
                                        To obtain your Gemini API key, log in to your Gemini account, navigate to the
                                        API section, and generate a new API key. Copy the key and paste it here. For more
                                        details on how to obtain your Gemini API key, visit the{' '}
                                        <a
                                            href="https://docs.gemini.com/rest-api/keys/"
                                            target="_blank"
